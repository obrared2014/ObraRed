<!-- cotización techo-->
            ...
            <tr>
                <td class="text-center"> <?php echo $_SESSION['idTablaTecho']?></td>
            ...
            <tr>
                <td class="text-center"><?php echo $_SESSION['idPlanchaTecho']?></td>
            ...
            <tr>
                <td class="text-center"><?php echo $_SESSION['idFieltroTecho']?></td>
            ...
            <tr>
                <td class="text-center"><?php echo $_SESSION['idClavoTecho']?></td>
